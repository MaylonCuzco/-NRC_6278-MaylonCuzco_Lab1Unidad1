...
# El robot agricultor comienza por la Parcela 3
    elif robotubicacion == 2:
            print("1. El robot agricultor se ubica en la Parcela 3")

            if parcela.ubicacionestado['P3'] == 1:
                print("2. La Parcela 3 está con mala hierba")
                parcela.ubicacionestado['P3'] == 0
                costo = costo + 1
                print("3. Se eliminó la mala hierba de la Parcela 3, el robot se mueve a la Parcela 2")

                if parcela.ubicacionestado['P2'] == 1:
                    print("4. La Parcela 2 está con mala hierba")
                    parcela.ubicacionestado['P2'] == 0
                    costo = costo + 1
                    print("5. Se eliminó la mala hierba de la Parcela 2, el robot se mueve a la Parcela 1")
                    
                else:
                   print("4. NO hay mala hierba en la Parcela 2, el robot de mueve a la Parcela 1")
            ...
            #Si la parcela 3 esta sin mala hierba, el robot se mueve hacia la Parcela 2 y despues a la Parcela 1
            else:
                print("2. NO hay mala hierba en la Parcela 3, el robot se mueve a la Parcela 2")
                ...
                if parcela.ubicacionestado['P2'] == 1:
                    ...
                    print("3. NO hay mala hierba en la Parcela 2, el robot de mueve a la Parcela 1")
